...
function ttfb_toolkit_sharing_get_markup(){
    ...
    if( empty( $share_options['disabled']['twitter'] ) ){
    ...
    if( empty( $share_options['disabled']['google'] ) ){
    ...
    if( empty( $share_options['disabled']['linkedin'] ) ){
    ...
    if( empty( $share_options['disabled']['pinterest'] ) ){
